...
import Googlepay from '../../assets/paytm.png';
const PaymentPage2 = () => {
  ...
  useEffect(() => {
    ...
    setPay1(`upi://pay?pa=${encodeURIComponent(res.payload.infoBank[0].upi2)}&pn=Merchant&am=${encodeURIComponent(rechargegetData?.money)}&cu=INR`);
    ...
    <div className=" h-[120vh]">
      <div className=" ">
        ...
        <div className="text-center mb-4">
          ...
          <p className="font-semibold mt-3">Pay with Paytm</p>
          <Link to={pay1}>
