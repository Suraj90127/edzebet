...
import Googlepay from '../../assets/phone-pay.png';
const PaymentPage3 = () => {
  ...
  useEffect(() => {
    ...
    setPay1(`upi://pay?pa=${encodeURIComponent(res.payload.infoBank[0].upi3)}&pn=Merchant&am=${encodeURIComponent(rechargegetData?.money)}&cu=INR`);
      ...
      <div className=" ">
        ...
        <div className='bgs-green mt-3 p-4'>
          ...
          <div className=" text-white py-4">
            <p className="text-3xl font-bold">trx{(rechargegetData?.money)?.toFixed(2)}</p>
          </div>
        ...
        <div className="text-center mb-4">
          ...
          <p className="font-semibold mt-3">Pay with phone pay</p>
          <Link to={pay1}>
