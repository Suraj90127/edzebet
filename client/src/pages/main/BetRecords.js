  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className='picker-bottom-highlight'></div>
            ...
            <div className="container-section">
                ...
                <div className='grid grid-cols-12 gap-2 mt-2'>
                    <div className='col-span-6 nav-bg flex cursor-pointer justify-between items-center p-2 rounded-md' onClick={handleOpenAll}>
                        <span className='text-base gray-50' >All</span>
                    ...
                    <div className='nav-bg rounded-xl  mt-3 pb-4 pt-3' key={i}>
                        ...
                        <ul className='px-2 mt-2'>
                            ...
                            <li className='flex  justify-between'>
                                ...
                                <span className=' text-sm  gray-100'>trx{data.amount}</span>
                            </li>
                        </ul>
                                ...
                                <div className='flex '>
                                    ...
                                    {(data.game.includes("wingo") || data.game.includes("trx")) && (
                                        <div className='flex  items-center'>
                                            ...
                                            <span className={` text-base p-1 ms-2 rounded-md px-2  ${data.result >= 4 ? "bg-yellow" : "bgs-blue-500"}`}>{data.result >= 4 ? "Big" : "Small"}</span>
                                            <span className={`text-base p-1 ms-2 rounded-md px-2 ${data.result == "0" ? "bg-red-voilet" : data.result == "5" ? "bg-green-voilet" : (data.result == 1 || data.result == 3 || data.result == 7 || data.result == 9) ? "bgs-green" : "bgs-red-200"}`}>
                        ...
                        <div className='flex item-center justify-between mb-4 mx-3 mt-5'>
                            <div className='bg-color-l  w-[48%] p-2 py-3 rounded-md flex justify-center items-center flex-col'>
                                <p className='text-sm gray-100'>trx{data.money}</p>
                            ...
                            <div className='bg-color-l w-[48%] p-2 rounded-md  flex justify-center items-center flex-col'>
                                <p className='text-sm gray-100'>trx{data.status == 1 ? data.get : 0.00}</p>
                                <p className='text-sm gray-100 '>Winnings</p>
                            </div>
                        </div>
                        <div className='flex item-center justify-between mb-3 mx-3'>
                            <div className='bg-color-l  w-[48%] p-2 py-3 rounded-md flex justify-center items-center flex-col'>
                                <p className='text-sm gray-100'>trx{data.fee}</p>
                                <p className='text-sm gray-100 '>Handling fee</p>
                            </div>

                            <div className='bg-color-l w-[48%] p-2 rounded-md  flex justify-center items-center flex-col'>
                                <p className={`text-sm  ${data.status == 1 ? "color-green" : "color-red-200"}`}>{data.status == 2 ? "-" : ""}trx{data.status == 1 ? (Number(data.get) - Number(data.amount)).toFixed(2) : Number(data.amount).toFixed(2)}</p>
            ...
            {openAll && (
              <div className="fixed bottom-0 left-0 right-0 p-3 m-auto w-[22.7rem] rounded-t-xl bg-[#1d1d2a]  shadow-lg">
                   <div className='grid grid-cols-12 gap-2 mt-2 mx-2'>
                    {allDate.map((item,i)=>(
                        ...
                        ${isName==item.name?"bg-color-l2":"nav-bg"}
