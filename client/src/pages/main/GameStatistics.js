        ...
        <>
            <div className='nav-bg p-1 py-3 sticky top-0'>
                <div className="container-section flex  items-center relative">
                    ...
                    <h1 className='heading-h1 gray-50 text-center flex justify-center items-center m-auto'>Game statistics</h1>
                </div>
            </div>

            <div className="container-section mt-5">
                <div className='flex items-center justify-between'>
                    <button className={`${activeTabs == "today" ? "blue-linear font-bold  color-orange" : "nav-bg gray-100"}  rounded-full p w-[24%] text-sm  p-1 flex items-center justify-center `} onClick={() => setActiveTabs("today")}>Today</button>
                    <button className={`${activeTabs == "yesterday" ? "blue-linear font-bold  color-orange" : "nav-bg gray-100"}  rounded-full p w-[24%] text-sm  p-1  flex items-center justify-center`} onClick={() => setActiveTabs("yesterday")}>Yesterday</button>
                    <button className={`${activeTabs == "this-week" ? "blue-linear font-bold  color-orange" : "nav-bg gray-100"}  rounded-full p w-[24%] text-sm  p-1  flex items-center justify-center`} onClick={() => setActiveTabs("this-week")}>This week</button>
                    <button className={`${activeTabs == "this-month" ? "blue-linear font-bold  color-orange" : "nav-bg gray-100"}  rounded-full p w-[24%] text-sm  p-1  flex items-center justify-center`} onClick={() => setActiveTabs("this-month")}>This month</button>
                </div>

                {activeTabs == "today" && (
                    <div>
                        <div className="nav-bg rounded-md mt-3 flex justify-center items-center flex-col h-40">
                            <h3 className="heading-h3 text-lg font-bold color-yellow-200">trx{todayData?.amountSum?.toFixed(2)
                            }</h3>
                        ...
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            ...
                            <ul className=''>
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm gray-100'>trx{Number(todayData?.amountSum)?.toFixed(2)}</span>
                                </li>
                                <li className='flex  justify-between'>
                                    <div className='flex '>
                                        <div className='flex  flex-col items-center mt-[3px] mr-1'>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>trx{Number(todayData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
                ...
                {activeTabs == "yesterday" && (
                    <div>
                        <div className="nav-bg rounded-md mt-3 flex justify-center items-center flex-col h-40">
                            <h3 className="heading-h3 text-lg font-bold color-yellow-200">trx{yesterdayData?.amountSum?.toFixed(2)
                            }</h3>
                            <p className='text-base  gray-100'>Total bet</p>
                        </div>
                        ...
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            ...
                            <ul className=''>
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm gray-100'>trx{Number(yesterdayData?.amountSum)?.toFixed(2)}</span>
                                </li>
                                <li className='flex  justify-between'>
                                    <div className='flex '>
                                        <div className='flex  flex-col items-center mt-[3px] mr-1'>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>trx{Number(yesterdayData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
                ...
                {activeTabs == "this-week" && (
                    <div>
                        <div className="nav-bg rounded-md mt-3 flex justify-center items-center flex-col h-40">
                            <h3 className="heading-h3 text-lg font-bold color-yellow-200">trx{weekData?.amountSum?.toFixed(2)
                            }</h3>
                            <p className='text-base  gray-100'>Total bet</p>
                        </div>
                        {weekData?.idCount>0  &&(                      
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            ...
                            <ul className=''>
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm gray-100'>trx{Number(weekData?.amountSum)?.toFixed(2)}</span>
                                </li>
                                <li className='flex  justify-between'>
                                    <div className='flex '>
                                        <div className='flex  flex-col items-center mt-[3px] mr-1'>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>trx{Number(weekData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
                ...
                {activeTabs == "this-month" && (
                    <div>
                        <div className="nav-bg rounded-md mt-3 flex justify-center items-center flex-col h-40">
                            <h3 className="heading-h3 text-lg font-bold color-yellow-200">trx{monthData?.amountSum?.toFixed(2)
                            }</h3>
                            <p className='text-base  gray-100'>Total bet</p>
                        </div>
                        {monthData?.idCount>0  &&(                      
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            ...
                            <ul className=''>
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm gray-100'>trx{Number(monthData?.amountSum)?.toFixed(2)}</span>
                                </li>
                                <li className='flex  justify-between'>
                                    <div className='flex '>
                                        <div className='flex  flex-col items-center mt-[3px] mr-1'>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>trx{Number(monthData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
