        ...
        <>
            <div className='blue-linear p-1 py-1 sticky top-0'>
                <div className="container-section flex  items-center relative py-2">
                    <button className='absolute'><Link >  <IoIosArrowBack className='text-xl' /></Link></button>
            ...
            <div className="blue-linear px-4 pb-10">
                ...
                <p className="fs-sm">Please log in with your phone number or email <br />
                    If you forget your password, please contact customer service
                </p>
            </div>
            <div className="container-section mt-5">
                <div className='flex items-center justify-center border-b border-[var(--bg-color-l)]'>
                    <div className={`flex flex-col justify-center items-center cursor-pointer  w-[50%] ${tabs == "phone" ? "border-b-2 border-[var(--bg-blue-500)]" : "border-b-2 border-transparent"}`}>
                        <span>
                            <ImMobile className={`${tabs == "phone" ? "color-blue-500" : "gray-50"} text-2xl`} />
                        </span>
                        <h3 className={`heading-h3 text-lg  font-medium font-sans  mt-1 leading-10 ${tabs == "phone" ? "color-blue-500" : "gray-50"} w-full text-center `}>Log in with phone</h3>
                    </div>
                        ...
                        <form action="" className='mt-5'>
                            <div>
                                <div className='flex items-center'>
                                    ...
                                    <label htmlFor="" className='font-sans  ms-1 gray-50'>Phone number</label>
                                </div>
                                <div className='mt-3 flex justify-between'>
                                    ...
                                    <input type="number" className='w-[75%] py-3  nav-bg border border-slate-900 rounded-lg p-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-slate-500' placeholder='Please enter your phone number'
                            ...
                            <div className='mt-4'>
                                <div className='flex items-center'>
                                    ...
                                    <label htmlFor="" className='font-sans ms-1 gray-50'>Password</label>
                                </div>
                            ...
                            <div className='flex items-center mt-4'>
                                <label className="flex items-center ">
                                    ...
                                    <span className="gray-100 ms-2 mr-2 text-sm cursor-pointer">Remember password</span>
                                </label>
                            </div>

                        </form>
                        <button className='blue-linear flex justify-center  text-lg  w-80   m-auto font-bold text-center  rounded-full p-2 mt-5 tracking-[3px]' onClick={handleSubmit}>Log in</button>
