...
const Register = () => {
    ...
    return (
        <>
            <div className='nav-bg p-1  sticky top-0'>
            ...
            <div className="container-section mt-3">
                ...
                <form action="" className='mt-5'>
                    <div>
                        ...
                        <div className='mt-3 flex justify-between'>
                            <div className='w-[24%] flex items-center justify-center font-bold text-sm gray-100 nav-bg rounded-lg '>
                                ...
                                <PhoneInput
                                    country={'in'} // Default country flag
                                    value={ccode}
                                    onChange={setCcode} // This will handle phone number change
                                    placeholder="Enter phone number"
                                    inputClass="my-custom-input" // Custom class if needed
                                />


                            </div>

                            <input type="number" className='w-[75%] py-2  nav-bg border border-[--bgbody] rounded-lg p-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-[--grey-100]' placeholder='Please enter the phone number'
                                name="username"
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='mt-3 flex justify-between relative'>
                            ...
                            <input
                                ...
                                className='w-full  nav-bg border border-[--bgbody] rounded-lg p-2 py-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-[--grey-100]' placeholder='Please enter the password'
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='mt-3 flex justify-between relative'>
                            ...
                            <input
                                ...
                                className='w-full  nav-bg border border-[--bgbody] rounded-lg p-2 py-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-[--grey-100]' placeholder='Please enter the confirm password'
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='mt-3 flex justify-between'>
                            <input type="text" className='w-full  nav-bg border border-[--bgbody] rounded-lg p-2 py-2 focus:border-slate-700 ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-[--grey-100]' placeholder='Please enter the invitation code'
                                name="invitecode"
                                onChange={inputHandle}
                ...
                <button className='blue-linear flex justify-center color-orange text-lg  w-72   m-auto font-semibold text-center  rounded-full p-1 mt-5 tracking-widest' disabled={loader ? true : false} onClick={() => handleSubmit()}>Register</button>
