...
const navigate=useNavigate();
        ...
        <>
            ...
            <div className="daily-signin-banner">
                <div className='w-[70%]'>
                    ...
                    <p className='text-base font-bold'>trx0.00</p>
                </div>
    ...
    >
        <p className='text-base'>trx{attendanceData?.[`total${day}`]?.toFixed(2) || '0.00'}</p>
        <img
            src={Coins}
            alt=""
        ...
        <span className='gray-100 fs-sm'>{day} day</span>
                ...
                <div className='nav-bg mt-2 p-3 rounded-md pb-10 flex items-center justify-between'>
                    ...
                    <div className='flex flex-col justify-center items-center mr-10'>
                        <p className='text-base font-medium'>trx6,000.00</p>
                        <p className='gray-100 text-base font-medium'>7 Day</p>
                    </div>
                </div>

                <button className='blue-linear w-[70%] color-orange m-auto flex justify-center rounded-full p-2 mt-4' disabled>Attendance</button>
            </div>
