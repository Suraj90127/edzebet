      ...
      <div className="container-section mt-3">
        <div className='nav-bg rounded-xl p-2 pb-0'>
          ...
          <div className=' pb-4 pt-2'>
            <button className={` py-2 rounded-3xl text-base w-full  heading-h3  font-bold  ${userInfo?.rebate>0?"blue-linear color-orange":"bg-gray-400 gray-50"}`} disabled={userInfo?.rebate<1?true:false} onClick={handleSubmit}>One-Click Rebate</button>
          </div>
