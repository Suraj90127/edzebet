        ...
        {platformData.map((items, i) => (
          <div className="col-span-4 bg-home-lg rounded-lg" key={i}>
            <img src={items} alt="" loading="lazy" className="w-full rounded-lg p-1 h-[120px]"
              ...
              onClick={() => {
                i === 0 && handleJilliOpen(224);
                i === 1 && handleJilliOpen(224);
                i === 2 && handleJilliOpen(252);
                i === 3 && handleJilliOpen(109);
                i === 4 && handleJilliOpen(223);
          ...
          <div className="col-span-4 mb-2" key={i}>
            <div className="bg-home-lg rounded-lg">
              <img src={items.img} alt="" loading="lazy" className="w-full rounded-lg p-1 h-[120px]"
                ...
                onClick={() => {
                  i === 0 && handleJilliOpen(51);
                  i === 1 && handleJilliOpen(109);
                  i === 2 && handleJilliOpen(223);
                  i === 3 && handleJilliOpen(47);
                  i === 4 && handleJilliOpen(35);
                  i === 5 && handleJilliOpen(49);


                  i === 6 && handleJilliOpen(82);
                  i === 7 && handleJilliOpen(27);

                  i === 8 && handleJilliOpen(252);
                  i === 9 && handleJilliOpen(94);
