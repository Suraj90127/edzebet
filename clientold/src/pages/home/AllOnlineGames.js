...
const navigate=useNavigate()
  ...
  const items = [
    { name: "Jilli", icon: <MdSportsBasketball  className="svg-white"/> },
    { name: "Crash", icon: <GiStarSwirl className="svg-white"/> },
    {
      name: "MG_Fish",
      icon: <GiFishingLure  className="svg-white"/>,
    },
    { name: "Rummy", icon: <BiHeartCircle  className="svg-white"/> },
    { name: "Slots", icon: <PiApplePodcastsLogo  className="svg-white"/> },
    { name: "Casino", icon: <GiArrowsShield  className="svg-white"/> },
  ];
