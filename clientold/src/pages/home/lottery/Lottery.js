    ...
    <>
      <div className="container-section">
        <div className="lottery--page-section">
          ...
          <div className="lottery-banner-section mt-2">
            <div className="insite-banner ">
              <div className='flex '>
                ...
                <div>
                  <h3 className="heading-h3">WIN GO Long</h3>
                  <p className='text-[12px] font-medium'>The lottery results for five</p>
                </div>
              </div>
              <button className="clickBtn bg-red-100 rounded-md text-red-600 text-[11px] p-1 px-2 font-medium">Enter {">>"} </button>
            </div>
          </div>
          ...
          <ul className='mt-5'>
            <li className=' bg-light flex p-2 rounded-md relative' onClick={()=>navigate("/WinGo")}>
            ...
            <li className='lottery-item mt-2 bg-light flex p-2 rounded-md relative' onClick={()=>navigate("/k3")}>
            ...
            <li className='lottery-item mt-2 bg-light flex p-2 rounded-md relative' onClick={()=>navigate("/5d")}>
