                ...
                {activeTabs == "today" && (
                    <div>
                        ...
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            <h2 className='flex items-center text-lg font-medium text-black'><MdSportsSoccer className='color-green text-2xl mr-1 mb-1' />lottery</h2>
                            ...
                            <ul className=''>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>₹{Number(todayData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
                        ...
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            ...
                            <ul className=''>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>₹{Number(yesterdayData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
                        ...
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            ...
                            <ul className=''>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>₹{Number(weekData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
                        ...
                        <div className='nav-bg rounded-md p-4 mt-3'>
                            ...
                            <ul className=''>
                                ...
                                <li className='flex  justify-between'>
                                    ...
                                    <span className=' text-sm  color-l'>₹{Number(monthData?.getSum)?.toFixed(2)}</span>
                                </li>
                            </ul>
