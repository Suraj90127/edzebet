  ...
  return (
    <>
      ...
      <div className="container-section mt-5">
        ...
        <h3 className="heading-h2 text-center gray-50">
      ...
      <div className="container-section mt-5">
        ...
        <h2 className="heading-h2 text-center gray-50">
          Interpretation and Definitions
        </h2>
        <h3 className="heading-h3 text-center gray-50">Interpretation</h3>
        <p className="fs-sm gray-50">
        ...
        <ul className="p-blak">
          ...
          <li className="p-blak">
            ...
            <text className="color-blue-500">https://bdgwin99.online</text>
          </li>
          <li className="p-blak">
        ...
        <h3 className="heading-h3 text-center gray-50">
        ...
        <ul>
          <li className="p-blak">Email address</li>
          <li className="p-blak">First name and last name</li>
          <li className="p-blak">Phone number</li>
          <li className="p-blak">Address, State, Province, ZIP/Postal code, City</li>
          <li className="p-blak">Usage Data</li>
        </ul>
        ...
        <ul>
          <li className="p-blak">Comply with a legal obligation</li>
          <li className="p-blak">Protect and defend the rights or property of the Company</li>
          <li className="p-blak">
          ...
          <li className="p-blak">Protect against legal liability</li>
        </ul>
        <h3 className="heading-h3 text-center gray-50">
        ...
        <ul>
          <li className="p-blak">By visiting this page on our website</li>
        </ul>
      </div>
    </>
  );
