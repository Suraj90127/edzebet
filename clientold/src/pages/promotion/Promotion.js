...
const Promotion = () => {
    const { promotionsData ,totalCommissionData,userInfo} = useSelector((state) => state.auth)
        ...
        <Layout>
            ...
            <div className='nav-bg p-1 py-3 sticky top-0 z-30'>
                <div className="container-section flex  items-center">
                    ...
                    <h3 className='heading-h3 text-black text-center flex justify-center items-center m-auto'>Agency</h3>
                    <Link to={"/promotion/Subordinate"} className='absolute right-2'><PiNoteFill className='color-blue text-2xl' /></Link>
                </div>
            </div>
            ...
            <div className="promotion-banner">
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className='promotion-member mt-2 flex items-center nav-bg w-[100%] rounded-lg relative z-10'>
                        <div className='w-[50%]'>
                            <div className='blue-linear flex items-center p-1 rounded-tl-lg'>
                            ...
                            <div className='flex  items-center justify-center flex-col text-center p-2'>
                                <div>
                                    <h5 className="heading-h5 text-black text-base">{promotionsData?.level1_count?promotionsData?.level1_count:'0'}</h5>
                                ...
                                <div>
                                    <h5 className="heading-h5 text-black text-base">{promotionsData?.firstDepositCount?promotionsData?.firstDepositCount:'0'}</h5>
                                    <p className='gray-100 fs-sm'>Number of people making first deposit</p>
                                </div>
                            </div>

                        </div>
                        <div className='w-[50%] border-l border-gray-100'>
                            <div className='blue-linear flex items-center p-1 rounded-tr-lg'>
                                <FaUsers className='color-blue text-2xl' />
                                <p className='text-sm ms-2 font-normal'>Team subordinates</p>
                            </div>
                            <div className='flex  items-center justify-center flex-col text-center p-2'>
                                <div>
                                    <h5 className="heading-h5 text-black text-base">{promotionsData?.level2_to_level6count?promotionsData?.level2_to_level6count:'0'}</h5>
                                    <p className='gray-100 fs-sm'>number of register</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <h5 className="heading-h5 text-black text-base">{promotionsData?.level2_to_level6firstDepositCount?promotionsData?.level2_to_level6firstDepositCount:'0'}</h5>
                                    <p className='gray-100 fs-sm'>Number of people making first deposit</p>
                                </div>
                            </div>
                        </div>
