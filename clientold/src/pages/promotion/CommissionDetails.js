    ...
    <>
      <div className='nav-bg p-1 py-3 sticky top-0 z-10'>
        <div className="container-section flex  items-center">
          ...
          <h1 className='heading-h1 gray-50 text-center flex justify-center items-center m-auto'>Commission details</h1>
        </div>
      </div>
      ...
      <div className="container-section mt-5">
          ...
          <div className='nav-bg rounded-md mt-3 pb-7 px-3 pt-1' >
           ...
           <hr className='border-color-slat mt-1' />
            <div className='mt-3 flex justify-between items-center bg-color-l gray-100 text-sm'>
              <span className='text-sm'>Number of bettors</span>
              <span className='text-sm  gray-50'>{totals.userLevel
              }</span>
            </div>

            <div className=' flex justify-between bg-color-l items-center mt-3 gray-100 text-sm'>
              <span className='text-sm font-medium'>Bet Amount</span>
              <span className='text-sm font-medium gray-50'>{totals.totalBetAmount.toFixed(2)}</span>
            </div>
            <div className=' flex justify-between bg-color-l items-center mt-3 gray-100 text-sm'>
            ...
            <div className=' flex justify-between bg-color-l items-center mt-3 gray-100 text-sm'>
              ...
              <span className='text-sm font-medium  gray-50'>{selectedDate?selectedDate:currentDate}</span>
            </div>
