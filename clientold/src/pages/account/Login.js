...
const Login = () => {
    ...
    useEffect(() => {
        if (userInfo?.id_user && location.pathname === '/login') {
            navigate('/');
        ...
        setPwd(localStorage.getItem("pass")?.length>6?localStorage.getItem("pass"):"")
...
{visible&&(
    ...
    <div className='absolute top-0 z-10 left-0 right-0 bottom-0 flex justify-center items-center'>
       ...
       />
            ...
            <div className='blue-linear px-1  sticky top-0'>
                ...
                <div className="container-section">
                    <div className='flex items-center justify-between border-b border-gray-300'>
                        <div className={`flex flex-col justify-center items-center cursor-pointer  w-[50%] ${tabs === "phone" ? "border-b-2 border-[var(--bg-color-l)]" : "border-b-2 border-transparent"}`} onClick={() => setTabs("phone")}>
                            <span>
                                <BsPhoneFill className={`${tabs === "phone" ? "color-l" : "gray-color"} text-2xl`} />
                            </span>
                            <h3 className={`heading-h3 text-base  font-medium font-sans   leading-7 ${tabs === "phone" ? "color-l" : "gray-color"} w-full text-center `}>phone number</h3>
                        </div>
                        <div className={`flex flex-col justify-center items-center cursor-pointer  w-[50%] ${tabs === "email" ? "border-b-2 border-[var(--bg-color-l)]" : "border-b-2 border-transparent"}`} onClick={() => setTabs("email")}>
                            <span>
                                <MdEmail className={`${tabs === "email" ? "color-l" : "gray-color"} text-2xl`} />
                            </span>
                            <h3 className={`heading-h3 text-base  font-medium font-sans  leading-7 ${tabs === "email" ? "color-l" : "gray-color"} w-full text-center `}>Email login</h3>
                        </div>
                    ...
                    {tabs === "phone" ? (
                        <div>
                            <form action="" className='mt-5'>
                                <div>
                                    ...
                                    <div className='mt-3 flex justify-between'>
                                        ...
                                        <input type="number" className='w-[75%] py-3  nav-bg border border-[--bgbody] rounded-xl p-2 focus:[var(--grey-200)] ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-[var(--grey-200)] placeholder:font-medium' placeholder='Please enter your phone number'
                                ...
                                <div className='mt-4'>
                                    ...
                                    <div className='mt-3 flex justify-between relative'>
                                        ...
                                        <input
                                            ...
                                            value={pwd}
                                            className='w-full  nav-bg border border-[--bgbody] rounded-xl p-2 py-3 focus:[var(--grey-100)] ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-[var(--grey-200)] placeholder:font-medium' placeholder=' Password'
                                        />
                            ...
                            <button className='blue-linear flex justify-center text-white text-lg  w-72   m-auto font-bold text-center  rounded-full p-1 mt-5 tracking-[3px]' onClick={handleSubmit}>Log in</button>
                        ...
                        <div>
                            <form action="" className='mt-5'>
                                <div>
                                    ...
                                    <div className='mt-3 flex justify-between'>
                                        ...
                                        <input type="text" className='w-full py-3  nav-bg border border-[--bgbody] rounded-xl p-2 focus:[var(--grey-100)] ps-6 flex items-center focus:border focus:outline-none  placeholder:text-sm placeholder:text-[var(--grey-200)] placeholder:font-medium' placeholder='Please enter your email'
                                            value={email}
                            ...
                            <button className='blue-linear flex justify-center  text-lg  w-72 text-white m-auto font-bold text-center  rounded-full p-1 mt-5 tracking-[3px]' disabled={loader ? true : false} onClick={() => handleSubmitEmail()}>Log in</button>
