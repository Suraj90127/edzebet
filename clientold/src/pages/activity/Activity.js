...
const Activity = () => {
  ...
  return (
    <Layout>
      <div className="flex justify-center  blue-linear sticky top-0">
        <img src={bannergetData?.gameall?.logo} alt="" loading="lazy"  className='w-36' />
      </div>

      {!userInfo &&(
        <Loader/>
      )}
      <div className='blue-linear p-3'>
      ...
      <div className="container-section mt-3">
        <div className="flex justify-around items-center">
          <div className=" flex flex-col justify-center items-center " onClick={() => navigate("/main/InvitationBonus")}>
            ...
            <p className='fs-sm black-2  text-center leading-3 mt-2'>Invitation <br /> bonus</p>
          </div>
          ...
          <div className=" flex flex-col justify-center items-center" onClick={() => navigate("/main/Laundry")}>
            ...
            <p className='fs-sm black-2  text-center leading-3 mt-2'>Betting <br /> rebate</p>
          </div>
          <div className=" flex flex-col justify-center items-center" onClick={() => navigate("/main/SuperJackpot")}>
            ...
            <p className='fs-sm black-2  text-center leading-3 mt-2'>Super<br />Jackpot</p>
          </div>
          <div className=" flex flex-col justify-center items-center" onClick={() => navigate("/activity/MemberPackage")}>
            ...
            <p className='fs-sm black-2  text-center leading-3 mt-2'>New member <br />gift package</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 gap-3 mt-5">
          <div className="col-span-6 nav-bg rounded-md" onClick={() => navigate("/main/RedeemGift")}>
            ...
            <div className='p-2 mb-3'>
              <h3 className="heading-h3 text-black  mb-1 text-sm font-bold">Gift</h3>
              <p className='black-2  fs-sm'>Enter the redemption code to recieve gift rewards</p>
            </div>
          </div>
          <div className="col-span-6 nav-bg rounded-md" onClick={() => navigate("/activity/DailySignIn")}>
            <img src={AttendanceImg} alt="" loading="lazy"  />
            <div className='p-2 mb-3'>
              <h3 className="heading-h3 text-black mb-1 text-sm font-bold">Attendance bonus</h3>
              <p className='black-2 fs-sm'>The more consecutive days you sign in, the higher the reward will be.</p>
            </div>
          </div>
        </div>
        ...
        <div className='nav-bg mt-3 rounded-xl'  onClick={()=>navigate("/activity/ActivityDetail?id=3")}>
          <img src={bannergetData?.activity?.ban3} alt="" loading="lazy"  className='rounded-t-xl h-44 w-full' />
        ...
        <div className='nav-bg mt-3 rounded-xl'  onClick={()=>navigate("/activity/ActivityDetail?id=4")}>
          <img src={bannergetData?.activity?.ban4} alt="" loading="lazy"  className='rounded-t-xl h-44 w-full' />
        ...
        <div className='nav-bg mt-3 rounded-xl'  onClick={()=>navigate("/activity/ActivityDetail?id=5")}>
          <img src={bannergetData?.activity?.ban5} alt="" loading="lazy"  className='rounded-t-xl h-44 w-full' />
        ...
        <div className='nav-bg mt-3 rounded-xl'   onClick={()=>navigate("/activity/ActivityDetail?id=6")}>
          <img src={bannergetData?.activity?.ban6} alt="" loading="lazy"  className='rounded-t-xl h-44 w-full' />
        ...
        <div className='nav-bg mt-3 rounded-xl'   onClick={()=>navigate("/activity/ActivityDetail?id=7")}>
          <img src={bannergetData?.activity?.ban7} alt="" loading="lazy"  className='rounded-t-xl h-44 w-full' />
