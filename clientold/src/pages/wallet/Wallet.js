...
const Wallet = () => {
  ...
  return (
    <Layout>
      <div className="blue-linear p-2 sticky top-0 z-10">
      ...
      <div className="blue-linear flex flex-col justify-center items-center py-4">
        <p>
          <IoWallet className="text-white text-4xl" />
        </p>
        ...
        <div className="nav-bg p-3 rounded-lg">
          <div className="flex  justify-between px-8 pt-4">
            <div className="relative inline-block">
              ...
              <span className="absolute gray-100 top-[30%] left-[40%]">0%</span>
            ...
            <div className="relative inline-block">
              <FaRegCircle className="text-[#e6e6e6] text-[100px]" />
              <span className="absolute gray-100 top-[30%] left-[40%]">0%</span>
              <p className="text-center text-sm gray-100">
                {" "}
                ₹
                {jilliWalletData?.Data &&
                  Number(jilliWalletData?.Data[0].Balance)}
              </p>
              <p className="text-center fs-sm gray-100">3rd party Wallet</p>
            </div>
          </div>
          <button
            className="blue-linear w-full p-1 text-lg font-bold my-2 rounded-full mt-3"
        ...
        <div className="grid grid-cols-12 gap-2 ">
          {LotteryData.map((item, i) => (
            ...
            >
              ...
              <span
                className="absolute wallet-svg top-4 text-6xl"
