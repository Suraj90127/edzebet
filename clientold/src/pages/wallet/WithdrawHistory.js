        ...
        <>
            <div className='nav-bg p-1 py-3'>
                <div className="container-section flex  items-center">
                    <button><Link onClick={handle}>  <IoIosArrowBack className='text-xl text-black' /></Link></button>
                    <h1 className='heading-h1 gray-50 text-center flex justify-center items-center m-auto'>Withdraw history</h1>
                </div>
            </div>
            ...
            <div className="container-section mt-5">
                {Array.isArray(withdrawHistoryData) && filteredData.map((item,i)=>(               
                <div className='nav-bg rounded-md mt-3 pb-7 px-3 pt-1' key={i}>
                    <div className=' mt-3 flex justify-between items-center rounded-sm  text-sm pb-2 border-b border-[--grey-200]'>
                        <span className='fs-sm font-medium bg-red-500 p-2 px-4 rounded-md '>Withdraw</span>
                    ...
                    <div className='mt-3 flex justify-between items-center gray-100 text-sm'>
                        ...
                        <span className='text-sm font-medium color-yellow-200'>{item.type==="BANK CARD"?`₹${Number(item.money).toFixed(2)}`:`$${Number((item.money)/87).toFixed(2)}`}</span>
                    </div>
                    ...
                    {/* <div className=' flex justify-between items-center  mt-3 gray-100 rounded-md text-sm p-3 bg-[#232e3f]'>
