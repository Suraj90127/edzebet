    ...
    return (htmls += `
                  <div data-v-a9660e98="" class="c-tc item van-row">
                      <div data-v-a9660e98="" class="van-col van-col--6">
                          <div data-v-a9660e98="" class="c-tc goItem" ></div>
                      </div>
       ...
       <span></span>
                  <!---->
                      ...
                      <div data-v-a9660e98="" class="van-col van-col--5">
                          <div data-v-a9660e98="" class="c-tc goItem">
                              <!---->
                              <span data-v-a9660e98="" class=""></span>

        <span data-v-a9660e98=""> </span>
                          </div>
                      </div>
    ...
    var firstGame;
     ...
     $.ajax({
          ...
          success: function (response) {
            ...
            console.log("ffffffffffff",firstGame)
            console.log("ssssssss",firstGame.stage)
            console.log("llllllllllll",list_orders[0].period)
...
function showListOrder(list_orders, x) {
  ...
  let htmls = "";
  let result = list_orders.map((list_orders) => {
        const dateStr = list_orders.time;
